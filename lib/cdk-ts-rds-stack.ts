...
export class CdkTsRdsStack extends cdk.Stack {
  ...
  const credentials = secrets.Secret.fromSecretCompleteArn(this, 'CredentialsSecret', 'arn:aws:secretsmanager:ca-central-1:975050262991:secret:rds-db-creds-HKiAj1');
  ...
  const createResolver = (name: string, entry: string) => new nodejs.NodejsFunction(this, name, {
    ...
    // Lambda function for getting all books from RDS table.
